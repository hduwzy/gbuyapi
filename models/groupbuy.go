...
type Groupbuy struct {
	...
	StartTime   time.Time `orm:";column(start_time);default(current_timestamp())" json:"start_time"`
	EndTime     time.Time `orm:";column(end_time);default(current_timestamp())" json:"end_time"`
